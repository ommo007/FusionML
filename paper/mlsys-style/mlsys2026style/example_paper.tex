%%%%%%%% mlsys 2026 EXAMPLE LATEX SUBMISSION FILE %%%%%%%%%%%%%%%%%
...
% \usepackage{mlsys2026} with \usepackage[nohyperref]{mlsys2026} above.
\usepackage{hyperref}
...
\mlsystitlerunning{Submission and Formatting Instructions for MLSys 2026}

\begin{document}

\twocolumn[
\mlsystitle{Submission and Formatting Instructions for MLSys 2026}

% It is OKAY to include author information, even for blind
% submissions: the style file will automatically remove it for you
% unless you've provided the [accepted] option to the mlsys2026
% package.
...
Submission to MLSys 2026 will be entirely electronic, via a web site
...
\texttt{nohyperref} as one of the options to the \texttt{mlsys2026}
...
$\mathit{9}^{th}$ MLSys Conference},
Bellevue, WA, USA, 2026.
Copyright 2026 by the author(s).''

For those using the \textbf{\LaTeX} style file, this change (and others) is
handled automatically by simply changing
$\mathtt{\backslash usepackage\{mlsys2026\}}$ to
$$\mathtt{\backslash usepackage[accepted]\{mlsys2026\}}$$
...
you are using \LaTeX\/ and the \texttt{mlsys2026.sty} file, use
...
A sample file with author names is included in the mlsys2026 style file
...
facility, use \texttt{natbib.sty} and \texttt{mlsys2026.bst}
